...
const GradientBorderContainersMobHyd = () => {
  return (
    <div className="min-h-screen block md:hidden bg-[black] py-12 px-4 sm:px-6 lg:px-8">
      <h2 className="text-4xl md:text-6xl text-white text-center max-w-3xl mx-auto font-bold font-inter mb-6">
...
export default GradientBorderContainersMobHyd;
