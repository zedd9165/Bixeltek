            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start">
                ...
                >
                    ...
                    <p className="text-gray-300 mb-6 font-poppins leading-relaxed max-w-2xl">
                        Think about your current website. Does it load slowly? Look outdated on mobile? 
                        Fail to bring in leads? You’re not alone. Many Toronto businesses face the same issues:
                    </p>
