      ...
      <div className="flex flex-col lg:flex-row items-center gap-16">
        ...
        >
          ...
          <p className="text-gray-300 mb-12 max-w-2xl leading-relaxed">
            ...
            In a competitive market like Toronto, this impression decides whether they stay or leave.
            Studies show 70% of users judge credibility based on design. A well-built website makes
            sure you’re the brand they trust.
          </p>
