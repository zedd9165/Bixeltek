      ...
      <div className="flex flex-col lg:flex-row items-center lg:items-start">
        ...
        >
          ...
          <p className="text-gray-300 mb-8 font-poppins leading-relaxed max-w-2xl">
            Web design is the process of creating a website that not only looks appealing but also
            works as a growth engine for your business. For Toronto businesses, effective web design
            blends aesthetics, user experience, speed, and SEO, ensuring customers trust your brand
            and find it easy to take action.
          </p>
