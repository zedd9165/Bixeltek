...
export default function TWHero() {
  ...
  return (
    <>
      <section className="relative flex flex-col items-center justify-center h-[100vh] lg:h-[90vh] bg-black text-center px-6 overflow-hidden">
          ...
          <div className="relative z-10 mt-40 max-w-7xl">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-8">
              {proofPoints.map((point) => (
                <div
                  key={point.id}
                  className="flex flex-col md:flex-row justify-center items-center gap-3 text-white max-w-[250px]"
                >
