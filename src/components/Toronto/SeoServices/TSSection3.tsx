            ...
            <div className="flex flex-col lg:flex-row items-center gap-12">
                ...
                >
                    ...
                    <p className="text-gray-300 mb-6 font-poppins leading-relaxed max-w-2xl">
                        Toronto is one of the most competitive business markets in Canada. With rising ad costs
                        and fragmented consumer attention, SEO ensures your brand is present where customers
                        look first — on Google.
                    </p>
