...
export default function WhySEOToronto() {
    return (
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start">
                ...
                >
                    ...
                    <h2 className="text-3xl md:text-6xl font-bold font-inter leading-snug mb-6">
                        ...
                        <span className="text-blue-500">Toronto Businesses</span>
                    </h2>

                    {/* Intro */}
                    <p className="text-gray-300 mb-6 font-poppins leading-relaxed max-w-2xl">
                        SEO (Search Engine Optimization) is the foundation of digital
                        competitiveness. It ensures your brand is visible when customers
                        search with intent. In Toronto’s competitive market, SEO provides a
                        compounding advantage — securing visibility, building credibility,
                        and reducing reliance on paid advertising.
                    </p>
                    ...
                    <ul className="space-y-4 mb-8">
                        <li className="flex gap-3">
                            ...
                            Capture demand at the exact moment customers are searching.
                        </li>
                        <li className="flex gap-3">
                            <Check className="text-blue-500 w-5 h-5 shrink-0 mt-1" />
                            Build long-term trust and credibility by ranking organically.
                        </li>
                        <li className="flex gap-3">
                            <Check className="text-blue-500 w-5 h-5 shrink-0 mt-1" />
                            Generate predictable leads 24/7.
                        </li>
                        <li className="flex gap-3">
                            <Check className="text-blue-500 w-5 h-5 shrink-0 mt-1" />
                            Future-proof visibility for both Google Search and AI-driven
                            platforms.
                        </li>
                    </ul>
