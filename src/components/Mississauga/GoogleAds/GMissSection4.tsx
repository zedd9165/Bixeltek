...
export default function GoogleAdsServicesMississauga() {
    const services = [
        {
            ...
            <div>
                ...
                <div className="max-w-[80%] mx-auto mb-5 text-center">
                    <h2 className="text-white text-4xl lg:text-6xl max-w-7xl mx-auto font-inter mb-3 font-semibold">
                        What We Deliver With <br /> <span className="text-blue-500">Our Google Ads Management</span>
                    </h2>
                    <p className="text-gray-100 text-base md:text-[17px] tracking-wider mt-4 max-w-4xl mx-auto">
                        Bixeltek provides end-to-end Google Ads management so your campaigns consistently bring in qualified leads.
                    </p>
                </div>
