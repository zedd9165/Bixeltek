...
export default function CampaignTabsSocialMiss() {
    const campaigns = [
        {
        ...
        },
        {
            ...
            description:
                "Create visibility and recognition across Mississauga with multi-platform campaigns tailored to your audience.",
            image: brand,
        },
        {
