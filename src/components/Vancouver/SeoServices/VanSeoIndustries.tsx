...
export default function SeoVanIndustries(): JSX.Element {
    ...
    return (
        <section className="lg:pt-20 mt-10 pb-10 md:pb-20  bg-[black] z-10 overflow-hidden">
           ...
           Google Ads works because it captures demand when it’s highest — when customers are searching for solutions. That makes it valuable across industries.
            ...
            <div className="carousel-container pl-[400px] lg:pl-[500px] relative w-full overflow-hidden">
                <div
