...
export default function SocialVanIndustries(): JSX.Element {
    ...
    return (
        <section className="md:pt-0 mt-10 pb-20  bg-[black] z-10 overflow-hidden">
            <div className="w-full relative text-center text-white pb-10">
                <h1 className="text-3xl md:text-5xl mx-auto max-w-[90%] md:max-w-full xl:text-7xl font-bold mb-2">
                    <span className=" text-transparent bg-clip-text bg-gradient-to-r from-white to-blue-500">
                         Social Media Marketing <br /> Across Greater Vancouver
                    </span>
                </h1>

                <p className="text-[16px] xl:text-lg text-gray-50 max-w-[100%] md:max-w-2xl mx-auto">
                Our social media experts help brands across Vancouver and nearby cities connect with their audience, run impactful campaigns, and grow faster online.
                </p>
            </div>
