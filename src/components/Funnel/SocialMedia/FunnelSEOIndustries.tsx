...
export default function IndustriesFunnelSEO(): JSX.Element {
    ...
    return (
        <section className="md:pt-10 md:mt-10 pb-10  bg-[white] z-10 overflow-hidden">
            <div className="w-full relative text-center text-white pb-10">
                <h1 className="text-2xl md:text-5xl mx-auto max-w-[90%] md:max-w-full xl:text-7xl font-bold mb-2">
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-700 to-purple-700">
                         We’ve Helped Businesses Across Every <br></br> Industry Scale Organically 
                    </span>
                </h1>
                <p className="text-[16px] xl:text-lg text-gray-950 mt-5 font-semibold max-w-[100%] md:max-w-2xl mx-auto">
                     From dental clinics to enterprise SaaS — our team has built SEO frameworks that adapt to your audience and local market dynamics.
                </p>
            </div>
