...
export default function FunnelSEOCase() {
  return (
   <>
   <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-20 mt-0 mx-auto">
                <div className="max-w-6xl mx-auto text-center mb-10 lg:mb-14">
                    <h2 className="text-4xl font-bold md:text-6xl font-inter md:leading-tight">
                        From Invisible to Unstoppable — <span className='text-blue-500'> <br /> Real SEO Growth Stories</span>
                    </h2>
                    <p className="mt-1 text-gray-900 max-w-4xl text-lg mx-auto">
                         We’ve helped dozens of businesses dominate their local markets using our holistic SEO systems.
                    </p>
                </div>
