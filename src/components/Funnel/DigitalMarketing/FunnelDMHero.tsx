...
export default function HeroFullSystemMarketing() {
  ...
  return (
    <section className="relative flex flex-col items-center justify-center h-[160vh] md:h-[100vh] bg-black text-center px-4 overflow-hidden">
        ...
        <div className="relative z-10 mt-40">
          ...
          <h1 className="text-4xl md:text-7xl font-bold leading-tight text-white max-w-6xl mx-auto">
            ...
            <span className="text-blue-500 relative inline-block">
              ...
              {/* bottom underline cursor — width matches text width (w-full of parent) */}
              <motion.span
                aria-hidden
                className="absolute left-0 right-0 bottom-[-6px] mx-auto w-full h-[3px] bg-blue-400"
