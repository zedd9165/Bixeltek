...
export default function BangaloreWebDndustries(): JSX.Element {
    ...
    return (
        <section className="pt-10 md:pt-10 -mt-2 -mb-2 pb-5 md:pb-20 bg-[#fff] z-10 overflow-hidden">
            ...
            <div className="controls flex justify-center mt-16 space-x-6"> {/* Increased margin top */}
                <motion.button
                    className="bg-gradient-to-r from-purple-600 to-purple-900 text-white p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 disabled:opacity-50"
                    onClick={handlePrev}
            ...
            <div className="flex justify-center mt-10 space-x-4">
                {cardData.map((_, index) => {
                    ...
                    return (
                        <motion.button
                            key={index}
                            className={`rounded-full transition-all duration-300 ${isActive ? 'bg-purple-600' : 'bg-gray-300'
                                }`}
                            style={{
