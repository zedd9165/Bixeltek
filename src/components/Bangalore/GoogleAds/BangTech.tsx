...
import gtm from '@/assets/google-tag-manager-logo-png_seeklogo-337292.png'
...
import looker from '@/assets/looker-studio-logo-png_seeklogo-617989.png'
...
const BangaloreTech = () => {
    ...
    const topRow = [
        ...
        { id: 3, name: looker, color: "border border-sky-400" },
    ...
    const bottomRow = [
        { id: 5, name: gtm, color: "border border-sky-400" },
