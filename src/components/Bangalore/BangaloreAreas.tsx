...
export default function BangaloreCoverageSection() {
  const points = [
  ...
  return (
    <section className="px-6 lg:w-[85%] mx-auto py-16 lg:py-24 flex flex-col lg:flex-row items-center justify-between gap-12 md:gap-20">
      {/* LEFT — Content */}
      <div className="w-full lg:w-1/2">
        <h2 className="text-3xl md:text-6xl font-semibold text-gray-900 leading-tight mb-6">
          Empowering Businesses Across{" "}
          <span className="text-blue-600">Every Corner of Bangalore</span>
        </h2>
      ...
      <div className="w-full lg:w-1/2 h-[320px] md:h-[450px] rounded-2xl overflow-hidden shadow-xl border border-gray-200">
        <iframe
