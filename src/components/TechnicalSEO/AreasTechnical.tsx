        ...
        <section className="relative w-full py-24 px-6 md:px-16 bg-black text-white overflow-hidden">
            ...
            <div className="relative z-10 max-w-4xl mx-auto text-center mb-12">
                <h2 className="text-3xl md:text-6xl font-semibold mb-4">
                   Global Reach,{" "}
                    <span className="text-blue-500"> Local SEO Precision</span>
                </h2>
                <p className="text-gray-300 text-lg">
                   We manage Technical SEO for clients across:
                </p>
            </div>
            ...
            <p className="relative z-10 text-center text-gray-300 mt-12 max-w-2xl mx-auto">
               Each region’s websites are localized for language, compliance, and hosting proximity — ensuring global presence with local performance.
            </p>
        </section>
    );
};
