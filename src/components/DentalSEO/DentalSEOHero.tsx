        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          >
            <motion.a
              ...
              className="px-8 py-3 bg-gradient-to-r cursor-pointer from-red-300 via-red-600 to-red-950 text-white font-bold rounded-full shadow-lg hover:shadow-xl transition-all duration-300 inline-flex items-center gap-3 text-base group"
