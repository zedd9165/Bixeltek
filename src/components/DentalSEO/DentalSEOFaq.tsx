...
const FAQAccordion = () => {
    ...
    return (
        <section className="py-20 bg-gradient-to-br from-red-950 via-red-700 to-red-950">
            <div className="mx-auto max-w-[95%] md:max-w-[85%] px-4 sm:px-6 lg:px-8">
                {/* Header */}
                <div className="text-center mb-16">
                    <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
                        Frequently Asked Questions
                        <span className="block text-transparent bg-clip-text bg-gradient-to-r from-white to-white mt-2">
                    ...
                    {faqs.map((faq, index) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className={`absolute inset-0 bg-gradient-to-r from-red-500/5 to-red-500/5 rounded-2xl transition-all duration-500 ${isOpen ? 'opacity-100 scale-100' : 'opacity-0 scale-95 group-hover:opacity-50'
                                    }`}></div>

                                <div className="relative border border-gray-700 rounded-2xl bg-gray-800/50 backdrop-blur-sm transition-all duration-500 hover:border-red-500/50 hover:shadow-2xl hover:shadow-red-500/10">
                                    <button
                                    ...
                                    >
                                        <div className="flex items-start space-x-6 flex-1">
                                            ...
                                            <div className={`flex-shrink-0 w-12 h-12 rounded-xl flex items-center justify-center text-base font-bold transition-all duration-500 ${isOpen
                                                ? 'bg-gradient-to-br from-red-500 to-red-500 text-white shadow-lg shadow-blue-500/25'
                                                : 'bg-white text-gray-900 group-hover:bg-red-600'
                                                }`}>
                                                {index + 1}
                                            </div>

                                            {/* Question */}
                                            <h3 className={`text-lg md:text-xl font-semibold pr-8 transition-all duration-300 ${isOpen ? 'text-white' : 'text-gray-200 group-hover:text-white'
                                                }`}>
                                                {faq.question}
                                            </h3>
                                        </div>
                                        ...
                                        <div className={`flex-shrink-0 w-6 h-6 flex items-center justify-center transition-all duration-500 ${isOpen
                                            ? 'text-red-400 transform rotate-180 scale-110'
