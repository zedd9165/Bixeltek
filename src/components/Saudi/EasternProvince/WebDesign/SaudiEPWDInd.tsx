...
export default function SaudiEPWDIndustries(): JSX.Element {
    ...
    return (
        <section className="md:pt-10 mt-10 md:pb-20  bg-[black] z-10 overflow-hidden">
            ...
            We design high-performing websites for businesses across sectors shaping Saudi Arabia’s economy:
                </p>
            </div>
