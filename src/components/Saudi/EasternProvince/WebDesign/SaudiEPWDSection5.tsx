...
export default function GrowthStatsSection() {
  ...
  return (
    ...
    >
      <motion.div
        className="relative w-full bg-black rounded-3xl p-6 md:p-16 shadow-[0_0_60px_rgba(0,225,128,0.6)] border border-green-400/40 flex flex-col items-center gap-8"
