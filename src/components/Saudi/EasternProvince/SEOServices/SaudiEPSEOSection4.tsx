...
const steps = [
  {
    number: "01",
    title: "Research & Entity Definition",
    text: "We identify your brand’s core entities, target queries, and search intent in Khobar, Dammam, and Dhahran.",
  ...
  },
  {
    ...
    text: "We fix site performance issues, implement schema markup, and make your website easily crawlable by Googlebot and Gemini.",
  ...
  },
  {
    ...
    text: "We design SEO-friendly page structures, topical clusters, and semantic links between services, cities, and industries.",
  ...
  {
    number: "04",
    title: "Authority & AI Integration",
    text: "We build backlinks from credible sources and integrate your data into AI discovery platforms.",
  ...
  },
  {
    ...
    text: "Weekly analytics, GSC data interpretation, and CTR improvement ensure continued visibility growth.",
