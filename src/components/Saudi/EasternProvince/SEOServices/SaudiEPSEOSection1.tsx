...
import searchImg from "@/assets/ai seo RANKINGS.png"; // ✅ replace with your relevant image
      ...
      <div className="flex lg:max-w-[85%] mx-auto gap-10 flex-col lg:flex-row items-center">
        ...
        <div className="relative w-full lg:w-1/2 flex justify-center items-center">
          <Image
            ...
            className="rounded-[0px] object-cover z-10"
          />
           <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-[#fffdf5] to-transparent z-20 pointer-events-none" />
