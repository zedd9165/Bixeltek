...
export const EPLogoTickerSaudiEP = () => {
  return (
    <section className='pb-20 bg-[#fffdf5] mt-0 pt-10 flex flex-col gap-20'>

      <div className="w-[90%] md:w-[90%] lg:w-[90%] mx-auto">
        <div className='flex items-center'>
          <div className='flex-1 md:flex-none mr-2 md:mr-5 lg:mr-8'>
          <h2 className='text-black text-sm font-semibold capitalize md:text-xl tracking-wide'>Trusted by top Companies</h2>
          </div>
