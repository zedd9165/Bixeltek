                ...
                <div className="md:w-1/2 space-y-6">
                    ...
                    <p className="text-gray-300 text-lg leading-relaxed">
                        ...
                        <span className="text-white font-semibold">
                            Al Olaya • Diriyah • Al Yasmin • Qurtubah • Al Sulimaniyah • Al Malaz • Al Nakheel • Al Narjis
                        </span>
                        <br />
                        Each district gets tailored meta data, landing copy, and Google Business localization.
                    </p>
