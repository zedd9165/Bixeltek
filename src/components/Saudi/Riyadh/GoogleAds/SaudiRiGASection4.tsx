...
const RiyadhGoogleAdsFramework = () => {
    ...
    return (
        <section className="bg-black max-w-[95%] md:max-w-[85%] mx-auto text-white py-12 md:py-24 px-6 md:px-20 text-center">
            {/* Heading */}
            ...
            <div className="flex flex-col md:flex-row justify-center items-center gap-10 md:gap-12">
                {cards.map((card, index) => (
                    ...
                    >
                        ...
                        {/* Inner Card */}
                        <div className="absolute inset-[3px] bg-neutral-900 rounded-2xl flex flex-col justify-evenly items-center text-center p-5">
                            <div>
                                <h3 className="text-3xl font-medium text-white mb-3">{card.title}</h3>
            ...
            {/* Closing Statement */}
            <p className="mt-14 text-lg text-gray-300 max-w-3xl mx-auto">
